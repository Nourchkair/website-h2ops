...
export const ContainerScroll = ({
  titleComponent,
  children,
  frameless = false,          // NEW: when true, no big card frame
}) => {
  ...
  return (
    ...
    >
      <div className="py-10 md:py-40 w-full relative" style={{ perspective: "1000px" }}>
        ...
        {frameless ? (
          // === Frameless variant: no big square; animate your child directly
          <motion.div
          ...
          // === Legacy framed card (kept in case you want it elsewhere)
